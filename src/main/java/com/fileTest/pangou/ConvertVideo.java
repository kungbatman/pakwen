...
public class ConvertVideo {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(ConvertVideo.class);
...
//        convert();
    ...
    public static String convert(File file, Boolean checkCompress) {
        ...
        try {
            ...
            LOGGER.info("wight:{},height:{}",frameGrabber.getImageWidth(), frameGrabber.getImageHeight());
            ...
            if(checkCompress && needCompress(file.length())){
                ...
                LOGGER.info("new wight:{},height:{}",widht, height);
            }
